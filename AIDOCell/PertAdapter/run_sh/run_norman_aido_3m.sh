...
result_dir=/l/users/ding.bai/scFoundation/aido_pert/results/aido_3m_pa_adj_weighted_de_loss-${TIMESTAMP}
...
LD_PRELOAD=/home/ding.bai/miniconda3/envs/aido/lib/libstdc++.so.6 \
    ...
    --proj_name="PertAdapt" \
    --aido_cell_config="aido_cell_3m" \
    --exp_name="aido_3m_pa_adj_weighted_de_loss-${TIMESTAMP}" > ${result_dir}/train.log 2>&1
...
LD_PRELOAD=/home/ding.bai/miniconda3/envs/aido/lib/libstdc++.so.6 \
    ...
    --proj_name="PertAdapt" \
    --aido_cell_config="aido_cell_3m" \
    --exp_name="aido_3m_pa_adj_weighted_de_loss-${TIMESTAMP}" > ${result_dir}/test.log 2>&1
