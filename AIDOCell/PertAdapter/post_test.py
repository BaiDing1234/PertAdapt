...
from gears import PertData, GEARSAdapt_test

def main(parser):
    args = parser.parse_args()

    cuda_visible_device = torch.cuda.current_device()
    ...
    gears_model = GEARSAdapt_test(pert_data, 
                        device = device,
    ...
    gears_model.model_initialize(hidden_size = args.hidden_size, 
                                 ...
                                 exp_name = args.exp_name,
                                 aido_cell_config = args.aido_cell_config,
                                 no_perturb=args.no_perturb)
    gears_model.test(epochs = args.epochs, 
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_class', type=str, default='GEARS_Model_Pert_Adapter_aido')
    ...
    parser.add_argument('--aido_cell_config', type=str, default='aido_cell_100m')
